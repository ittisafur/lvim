...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'barbar.nvim', 'nvim-toggleterm.lua', 'which-key.nvim', 'galaxyline.nvim', 'dashboard-nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
